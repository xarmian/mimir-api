...
// Handle POST request for marketplace listings with JSON body
...
// Handle GET request for marketplace listings
export const GET: RequestHandler = async ({ url }: { url: URL }) => {
  try {
    ...
    if (sold) queryParams.sold = sold === 'true';
    if (deleted) queryParams.deleted = deleted === 'true';
